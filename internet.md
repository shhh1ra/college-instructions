...
- Надо понимать какие интерфейсы настраивать, потому что можно застрять на том, что все настроено, но настроено не то/не так, и не понимать в чем проблема. Сага про интерфейсы будет расписана в отдельном файле.
****
