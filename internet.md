...
```
4. Через дранный vim (vi) надо внести конфиги в путь /etc/net/ifaces/ens38/options К слову не сразу понял, но options это файл, не каталог.
5. Заход на огонек: sudo vi /etc/net/ifaces/ens38/options
